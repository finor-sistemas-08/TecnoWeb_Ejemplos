...
<center><form id="form1" name="form1" method="post" action="frmProducto.php">
<fieldset id="form">
<legend>REGISTRO DE PRODUCTOS</legend>
  <table width="325" border="0">
    ...
    <input name="txtIdProducto" type="hidden" value="<?php echo $cod; ?>" id="txtIdProducto" />
    <label></label></td>
    </tr>
    <tr>
      <td width="79">Descripcion</td>
      <td width="253"><label>
	  <?php $des=$_GET['pdescripcion']; ?>	  
        <input name="txtDescripcion" type="text"  value="<?php echo $des; ?>" id="txtDescripcion" />
      </label></td>
    </tr>
    <tr>
      <td>Precio</td>
      <td><label>
  	<?php $pre=$_GET['pprecio']; ?>	  
        <input name="txtPrecio" type="text" value="<?php echo $pre; ?>" id="txtPrecio" />
      </label></td>
    </tr>
    <tr>
      <td>Categoria</td>
   ...
   {
   ?>
   <option <?php if($_GET['pcategoria']==$fila['nombre']) echo "selected";  else ?>  value="<?php echo $fila['id_categoria']; ?>">
