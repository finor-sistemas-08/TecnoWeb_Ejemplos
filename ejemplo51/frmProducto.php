...
<form id="form1" name="form1" method="post" action="frmProducto.php">
  <table width="400" border="1">
    <tr>
      <td width="80"> </td>
      <td width="225">	 	  
        <input name="txtIdProducto" type="hidden"  value="<?php echo $_GET['pid_producto']; ?>" 
        id="txtIdProducto" />
      </td>
    </tr>
    <tr>
      ...
      <td width="225">	 	  
        <input name="txtDescripcion" type="text"  value="<?php echo $_GET['pdescripcion']; ?>" 
        id="txtDescripcion" />
      </td>
    </tr>    
     <tr>
    ...
    <tr>
      ...
      <td width="225">	  	          
      <input name="txtNombreCat" type="text" value="<?php echo $_SESSION['nombre_cat']; ?>" id="txtNombreCat" />
      <a href="#" onClick="abreBuscarCategoria()">Buscar</a>	
      <input name="txtIdCategoria" type="text" readonly="true" size="3" 
      value="<?php echo $_SESSION['id_categoria']; ?>" id="txtIdCategoria" />
     </td>
	</tr>
